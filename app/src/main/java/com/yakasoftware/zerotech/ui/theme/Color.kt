...
//Açık Tema
val beyaz = Color(255, 255, 255, 255)
val turuncu = Color(255, 165, 0, 255)
val aciksiyah = Color(255, 229, 218, 255)
val acikturuncu = Color(255, 153, 102, 255)
val krem = Color(230, 230, 230, 255)
val koyukirmizi = Color(182, 27, 27, 255)
val koyukrem = Color(143, 100, 60, 255)
...
val acikkrem = Color(226, 186, 149, 255)